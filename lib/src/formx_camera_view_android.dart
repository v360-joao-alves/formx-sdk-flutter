...
/// A widget connected to native camera view on Android
class FormXCameraViewAndroid extends FormXCameraViewPlatform {
  ...
  Widget buildWidget(
    ...
    return AndroidView(
      key: key,
      viewType: "formx_sdk_flutter/camera_view_android",
